...
function FeaturedCourses() {
    ...
    return (
        <div className="py-20 relative z-20 overflow-hidden">
            <div>
            ...
            <div className="mt-20 text-center">
                <Link
                    href={"/courses"}
                    className="px-8 py-3 rounded-full border border-neutral-700 text-neutral-300 bg-transparent hover:bg-neutral-900 transition duration-300 font-medium"
                >
                    View All Courses
                </Link>
            </div>
